...
pub mod Quests {
    ...
    pub impl QuestsImpl of super::IQuest {
        fn initQuests(ref world: WorldStorage) {
        ...
        fn claimGlobalRewards(ref world: WorldStorage, owner: ContractAddress, map: u16, mapProgressRequired: u16) {
            ...
            let accountGlobalQuest: AccountQuests = world.read_model((owner, map, mapProgressRequired));
            ...
            match quest.rewardType {
                RewardType::Summon => {
                    AccountsImpl::increaseSummonChests(ref world, owner, quest.rewardQuantity);
                },
                RewardType::Rune => {},
                RewardType::Crystals => {},
            }
