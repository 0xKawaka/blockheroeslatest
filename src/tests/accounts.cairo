...
//         let account  = AccountsImpl::getAccount(ref world, caller);
...
//         AccountsImpl::decreaseEnergy(ref world, caller, 1);
//         let account  = AccountsImpl::getAccount(ref world, caller);
...
//         AccountsImpl::decreaseCrystals(ref world, caller, 21);
//         let account  = AccountsImpl::getAccount(ref world, caller);
//         assert(account.crystals == startCrystal - 21, 'Crystal not decreased');
//         AccountsImpl::increaseCrystals(ref world, caller, 23);
//         let account  = AccountsImpl::getAccount(ref world, caller);
//         assert(account.crystals == startCrystal + 2, 'Crystal not increased');

//         let hero = AccountsImpl::getHero(ref world, caller, 2);
//         AccountsImpl::addExperienceToHeroId(ref world, caller, 2, 20);
//         let heroAfter = AccountsImpl::getHero(ref world, caller, 2);
//         assert(heroAfter.experience == hero.experience + 20, 'Experience not increased');

//         let accountBefore = AccountsImpl::getAccount(ref world, caller);
//         AccountsImpl::mintHero(ref world, caller);
//         let accountAfter = AccountsImpl::getAccount(ref world, caller);
//         assert(accountAfter.heroesCount == accountBefore.heroesCount + 1, 'Hero not minted');
//         let hero = AccountsImpl::getHero(ref world, caller, accountAfter.heroesCount - 1);
...
//         let accountBefore = AccountsImpl::getAccount(ref world, caller);
//         AccountsImpl::mintRune(ref world, caller);
//         let accountAfter = AccountsImpl::getAccount(ref world, caller);
//         assert(accountAfter.runesCount == accountBefore.runesCount + 1, 'Rune not minted');
//         let rune = AccountsImpl::getRune(ref world, caller, accountAfter.runesCount - 1);
...
//         let accountBefore = AccountsImpl::getAccount(ref world, caller);
//         AccountsImpl::upgradeRune(ref world, caller, 0);
//         AccountsImpl::upgradeRune(ref world, caller, 0);
//         let accountAfter = AccountsImpl::getAccount(ref world, caller);
//         let rune = AccountsImpl::getRune(ref world, caller, 0);
//         assert(rune.rank == 2, 'Rune rank not 2');
//         assert(accountAfter.crystals < accountBefore.crystals, 'Crystal not decreased');

//         AccountsImpl::equipRune(ref world, caller, 1, 3);
//         let runeAfter = AccountsImpl::getRune(ref world, caller, 1);
//         let heroAfter = AccountsImpl::getHero(ref world, caller, 3);
...
//         AccountsImpl::unequipRune(ref world, caller, 1);
//         let runeAfter = AccountsImpl::getRune(ref world, caller, 1);
//         let heroAfter = AccountsImpl::getHero(ref world, caller, 3);
//         assert(heroAfter.getRunesIndexArray().len() == 0, 'Rune not unequipped 1');
//         assert(runeAfter.isEquipped == false, 'Rune not unequipped 2');

//         let runes = AccountsImpl::getAllRunes(ref world, caller);
//         let heroes = AccountsImpl::getAllHeroes(ref world, caller);
